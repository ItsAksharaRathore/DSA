#include <iostream> 
using namespace std; 
void enqueue(); void dequeue(); void traversal(); 
struct node
{
int data; node *next;
...
void enqueue()
{
node *p = new node; cout << "Enter data: "; cin >> p->data;
p->next = NULL; if (f == NULL)
{
f = r = p;
}
else
...
{
cout << "Deleted element has data: " << f->data << endl; f = r = NULL;
}
else
{
cout << "Deleted element has data: " << f->data << endl; f = f->next;
}
}
void traversal()
{
